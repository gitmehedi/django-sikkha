...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		...
		buildPagination : function(){
			...
			base.paginationWrapper.on(base.getEvent(), ".owl-doctor", function(event){
				event.preventDefault();
				if(Number($(this).data("owl-doctor")) !== base.currentSlide){
					base.goTo( Number($(this).data("owl-doctor")), true);
				}
			});
		},
		...
		updatePagination : function(){
			...
			for(var i = 0; i<base.itemsAmount; i++){
				if(i % base.options.items === 0){
					...
					paginationButton.data("owl-doctor",lastPage === i ? lastItem : i);
		...
		checkPagination : function(){
			...
			base.paginationWrapper.find(".owl-doctor").each(function(i,v){
